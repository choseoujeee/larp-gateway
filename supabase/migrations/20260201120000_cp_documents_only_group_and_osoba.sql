-- CP vidí jen dokumenty skupiny CP a dokumenty pro konkrétní osobu (ne "vsichni")
-- Viz zpětná vazba: "CPčkům se nemají zobrazovat dokumenty společné pro všechny"
...
BEGIN
    ...
    IF v_person_type = 'cp' THEN
        -- CP vidí jen: skupina CP + dokumenty pro tuto osobu (ne "vsichni")
        RETURN QUERY
