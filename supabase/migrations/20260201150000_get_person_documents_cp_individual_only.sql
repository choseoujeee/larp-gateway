-- Na portálu konkrétní CP zobrazovat jen individuální dokumenty (životopis, vztahy), žádné společné.
...
BEGIN
    ...
    IF v_person_type = 'cp' THEN
        -- Portál konkrétní CP: pouze dokumenty pro tuto osobu (životopis, vztahy), žádné společné.
        RETURN QUERY
