-- Produkční dokumenty (nákupní seznamy, sklad) jsou jen pro produkční portál, ne pro hráče.
-- get_person_documents je pro portál hráče – vyloučíme doc_type = 'produkční'.
