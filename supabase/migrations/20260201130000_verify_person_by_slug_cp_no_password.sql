-- Portál konkrétní CP (/hrac/:slug) bez hesla: CP s prázdným nebo null password_hash
-- má přístup bez zadání hesla. Postavy a CP s nastaveným heslem dál vyžadují heslo.
