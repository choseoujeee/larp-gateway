-- Zápatí portálu na úrovni LARPu (jedno pro všechny běhy, hráče i CP), podpora více řádků
ALTER TABLE public.larps ADD COLUMN IF NOT EXISTS footer_text TEXT;

-- verify_person_by_slug: vrací zápatí z LARPu (l.footer_text) jako run_footer_text
...
-- get_portal_session_as_organizer: vrací zápatí z LARPu (l.footer_text) jako run_footer_text
